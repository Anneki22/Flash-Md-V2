...
const conf = {
  ...
  ON: process.env.OWNER_NAME || "死_ＮＥＭＥＳ１Ｘ",
  ...
  PREFIXES: process.env.PREFIX ? process.env.PREFIX.split("X").map(p => p.trim()).filter(p => p) : [],
  Session: process.env.SESSION || "",
  NUMBER: process.env.OWNER_NUMBER || "2348077825595",
